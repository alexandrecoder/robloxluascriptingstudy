...
--[[ Variavel local function variavelLocal ()
...
--[[ funcao com parametro function imprimirParametro (meuTexto)
...
--[[ função usando mais de um parametro function imprimirMaisparametro (tempo, clima)
